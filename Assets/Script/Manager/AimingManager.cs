...
public class AimingManager : MonoBehaviour
{
    ...
    /// 조준을 시작합니다.
    /// </summary>
    /// <param name="starter">조준을 시작하는 오브젝트</param>
    /// <param name="onResolvedCallback">조준이 끝났을 때 타겟 정보를 받아 실행될 함수</param>
    public void StartAiming(GameObject starter)
    {
        this.startObject = starter;
        this.startRectTransform = starter.GetComponent<RectTransform>();
